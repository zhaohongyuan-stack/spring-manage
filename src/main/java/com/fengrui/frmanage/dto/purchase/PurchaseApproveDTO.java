...
public class PurchaseApproveDTO {
    ...
    @Schema(description = "审批人用户ID", example = "1005", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long approverUserId;

    @NotNull(message = "审批结果不能为空")
    @Schema(description = "审批结果，true通过，false驳回", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
