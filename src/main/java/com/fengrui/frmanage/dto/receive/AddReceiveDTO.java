...
public class AddReceiveDTO {
    ...
    @Schema(description = "领用部门ID", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long deptId;
    ...
    @Schema(description = "用途说明", example = "3楼客房一次性用品补充", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "领用明细列表", requiredMode = Schema.RequiredMode.REQUIRED)
