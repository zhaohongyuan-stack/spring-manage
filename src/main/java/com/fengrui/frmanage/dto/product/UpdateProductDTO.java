...
public class UpdateProductDTO {
    ...
    @Schema(description = "【商品ID】必填", example = "2", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long productId;

    @DecimalMin(value = "0.00", message = "成本单价不能小于0")
    @Digits(integer = 14, fraction = 2, message = "成本单价最多14位整数和2位小数")
    @Schema(description = "【成本单价】可选，传则更新", example = "4.30")
    private BigDecimal costPrice;

    @Min(value = 0, message = "预警阈值不能小于0")
    @Schema(description = "【预警阈值】可选，传则更新", example = "25")
