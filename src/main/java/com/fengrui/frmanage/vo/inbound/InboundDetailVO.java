...
public class InboundDetailVO {
    ...
    @Schema(description = "收货人ID", example = "2001")
    ...
    @Schema(description = "验收人ID", example = "1005")
    private Long deptHeadId;

    @Schema(description = "验收人姓名", example = "李经理")
    private String deptHeadName;

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Schema(description = "验收时间", example = "2026-06-10 15:00:00")
